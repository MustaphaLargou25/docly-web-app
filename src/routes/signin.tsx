      ...
      <div className="w-full md:max-w-[420px] md:bg-card md:border md:border-divider md:rounded-2xl md:p-8">
        ...
        >
          ...
          <div className="text-end">
            <button type="button" className="text-[12px] text-primary font-semibold">Forgot password?</button>
          </div>
        ...
        <Button variant="outline" className="w-full" size="lg" onClick={() => toast("Google sign-in")}>
